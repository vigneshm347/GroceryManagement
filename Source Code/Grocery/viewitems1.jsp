...
ResultSet rs2=null,rs3=null,rs4=null,rs=null;
String url=null,url2=null;
int a=0;
int top=-100,left=100;
rs4=st4.executeQuery("select * from subcategory where cid='"+cat+"'");
while(rs4.next())
{
rs=st.executeQuery("select * from item where subcat='"+rs4.getInt(1)+"'");
